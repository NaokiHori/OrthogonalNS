...
Finally I obtain an explicit relation of the Christoffel symbol of the second kind and the scaling factors (the indices are interchanged for later convenience):
